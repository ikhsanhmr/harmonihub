...
//         $this->conn = self::getInstance(); // Ambil instance PDO
//     }
...
//     {
//         $stmt = $this->conn->query($sql); // Menjalankan query tanpa parameter
//         return $stmt->fetchAll(PDO::FETCH_ASSOC); // Mengambil semua hasil dalam bentuk array asosiatif
//     }

//     // Menjalankan query dengan parameter (prepared statement)
...
//         return $stmt->fetchAll(PDO::FETCH_ASSOC); // Mengambil hasilnya
//     }
