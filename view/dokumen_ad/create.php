        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="index.php?page=dokumen_ad/store" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="kategori" id="kategori" class="form-control" required>
                                <option value="1">Laporan Pemetaan Alih Daya</option>
                                <option value="2">Laporan Pengelolaan Alih Daya</option>
                                <option value="3">Laporan Lain-lain</option>
                            </select>
                        </div>
                        <div class="form-group">
