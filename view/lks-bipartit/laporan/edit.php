                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="topik_bahasan" id="topik_bahasan" class="form-control"><?php echo htmlspecialchars($laporan['topik_bahasan']); ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="latar_belakang">Latar Belakang</label>
                                    <textarea name="latar_belakang" id="latar_belakang" class="form-control"><?php echo htmlspecialchars($laporan['latar_belakang']); ?></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                            <div class="form-group">
                                    <label for="rekomendasi">Rekomendasi</label>
                                    <input type="text" class="form-control" id="rekomendasi" name="rekomendasi" value="<?php echo htmlspecialchars($laporan['rekomendasi']); ?>" required>
                                </div>
                                <div class="form-group">
