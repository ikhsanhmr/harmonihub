                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="index.php?page=terima-ba-pembentukan&id=<?php echo $ba['id']; ?>" class="btn btn-success btn-sm">Terima</a>
                                            <a href="index.php?page=ba-pembentukan-delete&id=<?php echo $ba['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Tolak Ba Pembentukan ini?')">Tolak</a>
                                        </td>
                                    </tr>
                                <?php
                                }
