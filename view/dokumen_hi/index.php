...
<div class="content-wrapper">
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Data Database HI</h4>
                    <div style="float: left">
                        <form method="GET" action="index.php?page=dokumen_hi">
                            <input type="hidden" name="page" value="dokumen_hi">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <a href="index.php?page=dokumen_hi" id="filter-link" class="btn btn-sm btn-primary ms-2">
                                        Filter
                                    </a>
                                </div>
                            </div>
                    ...
                    <div style="float: right">
                        <a href="index.php?page=dokumen_hi/create" class="btn btn-success btn-sm">
                            Tambah Data
                        </a>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            switch ($dokumen['kategori']) {
                                                case 1:
                                                    echo "Laporan Tuntutan Ganti Rugi";
                                                    break;
                                                case 2:
                                                    echo "Laporan PPHI";
                                                    break;
                                        ...
                                        <td class="d-flex justify-content-center">
                                            ...
                                            <form action="index.php?page=dokumen_hi/delete" id="delete-form-dok-<?= $dokumen['id'] ?>" method="POST">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateFilterLink() {
            ...
            let newUrl = 'index.php?page=dokumen_hi';
