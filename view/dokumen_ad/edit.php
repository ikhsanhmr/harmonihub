        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="index.php?page=dokumen_ad/update" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="kategori" id="kategori" class="form-control" required>
                                <option value="1" <?= $dokumen['kategori'] == 1 ? 'selected' : ''; ?>>Laporan Pemetaan Alih Daya</option>
                                <option value="2" <?= $dokumen['kategori'] == 2 ? 'selected' : ''; ?>>Laporan Pengelolaan Alih Daya</option>
                                <option value="3" <?= $dokumen['kategori'] == 3 ? 'selected' : ''; ?>>Laporan Lain-lain</option>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <a href="index.php?page=dokumen_ad" class="btn btn-warning btn-sm">
                                Kembali
                            </a>
                        </div>
                    </form>
