...
<div class="content-wrapper">
    <div class="row">
        <div class="col-md-6 offset-3 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Tambah BA perubahan</h4>

                    <form action="index.php?page=ba-perubahan-store" method="POST" enctype="multipart/form-data">
                       ...
                       <?php }?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="no_ba" id="no_ba" required>
                        </div>
                        <div class="form-group">
