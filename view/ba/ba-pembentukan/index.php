                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="index.php?page=ba-pembentukan-edit&id=<?= $ba['id']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                            <a href="index.php?page=ba-pembentukan-delete&id=<?= $ba['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this data?')">Delete</a>
                                        </td>
                                    </tr>
                                <?php
                                }
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="GET" action="">
                            <div class="row">
                            <input type="hidden" name="page" value="ba-pembentukan-list">
                                <div class="col-md-12">
